    ...
    <div class="slide">
      <div class="tab-nav">
        <div class="nav-li" @click="tabAllNav(1)">
          <image class="nav-icon" src="https://frontendsvn.360che.com/icon-project/wap/app/TruckFriendCircle/images/new-btn.png"></image>
        </div>
        ...
        <div class="nav-li" @click="tabAllNav(3)">
          <image class="nav-icon" src="https://frontendsvn.360che.com/icon-project/wap/app/TruckFriendCircle/images/follow-select.png"></image>
        </div>
      </div>
      <list class="list" @loadmore="morefol" loadmoreoffset="50">
        ...
        <cell v-for="(item, index) in folTab.DATA" class="row" :index="index" keep-scroll-position="true">
