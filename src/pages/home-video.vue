<template>
  <div class="wrapper">
      <div>
        ...
        <div class="tab-nav">
          ...
          <div class="nav-li" @click="tabAllNav(2)">
            <image class="nav-icon" src="https://frontendsvn.360che.com/icon-project/wap/app/TruckFriendCircle/images/video-select.png"></image>
          </div>
      ...
      <list class="list" @loadmore="morevid" loadmoreoffset="50">
        ...
        <cell v-for="(item, index) in vidTab.DATA" class="row" :index="index" keep-scroll-position="true">
